...
Route::group(['middleware' => ['auth:api', 'is_user']], function () {
    Route::prefix('users')->group(function(){
        ...
        Route::prefix('games')->group(function () {
            ...
            Route::get('free-credits', 'Games\GameFreeCreditsController@index');
        });
        ...
        Route::post('payment-request-link', 'Payments\Red6six\DepositController@paymentRequestLink');
...
Route::group(['middleware' => ['auth:api', 'is_admin']], function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('games/{game}')->group(function () {
            ...
            Route::post('update-winners', 'Games\GameAdminController@updateWinners');
        });
        ...
        Route::resource('deposits', 'Payments\Red6six\DepositAdminController')->only(['index', 'store']);
