...
(function updateModules () {
  ...
  resolveStoreModules(require('../client/store/businesses.js'), 'businesses.js')
  ...
  resolveStoreModules(require('../client/store/profile.js'), 'profile.js')
