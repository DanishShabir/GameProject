...
class UserAdminTransformer extends BaseTransformer
{
    ...
    public function includeHearAboutUs(User $user)
    {
        $item = [
            'id' => $user->hearAboutUsPlatform ? $user->hearAboutUsPlatform->id : null,
            'name' => $user->hearAboutUsPlatform ? $user->hearAboutUsPlatform->name : null
        ];
