...
use App\Http\Requests\Payments\Red6six\AddCreditsRequest;
...
class DepositAdminController extends Controller
{
    ...
    public function store(AddCreditsRequest $request) : JsonResponse
    {
        $deposit = $this->service->addCredits($request->validated());
    ...
    {
        $deposits = $this->success(Deposit::all(), $this->transformer);
        return $this->service->downloadCsv($deposits);
    }
}
