...
class InvitationCode extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line("You can now share the link with your friends and family via any messaging service or Social Media platform. Each friend that plays will earn you 3 free credits.")
