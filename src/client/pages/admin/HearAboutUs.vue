<template>
  <div class="flex items-center flex-col">
    ...
    <div class="flex mt-4 lg:w-2/4">
      <base-table
        class="w-full"
        table-title="Traffic Sources"
        :header-items="trafficSourcesHeaderItems"
        :records="platformsWithCount"
        text-color="text-white"
      >
        <template slot="no-items"> Nothing Found </template>
      </base-table>
...
export default {
  ...
  async asyncData({ store }) {
    ...
    await store.dispatch('AdminHearAboutUsStore/getAllPlatformsWithCountHAU')
  },
  data: () => ({
