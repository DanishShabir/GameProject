    ...
    >
      ...
      >
        ...
        <div class="game-card-body p-4 border-red border-t-4 flex-1">
          ...
          <span>Choose your launch point, aim, then fire the balls to destroy the blocks.</span>
        ...
        >
          <span class="text-white font-bold text-2xl text-center"
            >Please purchase credits to enter competitions. <br /><span class="text-gold font-bold text-2xl text-center mt-5">Buy Credits</span>
          </span>
        </div>
      </nuxt-link>
    </div>
