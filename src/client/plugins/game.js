    ...
    fetch(this.end_point + '/game_sessions/' + this.session_id)
      .then(function (response) {
        if (response.status !== 200) {
          console.log('Looks like there was a problem with the server. Status Code: ' + response.status)
...
const $a47b39a1f68b769584aa5500ce61083b$export$default = new $a47b39a1f68b769584aa5500ce61083b$var$GameApi()
...
class $ef2a5e9f4cd262a692c86fe33270bb4$export$default extends $c3449a2e8f44a086b821dce4a5f0b801$export$default {
  ...
  update(camera_controller) {
    ...
    if (Input.left_mouse_button_down) {
      ...
      camera_controller.set_rotation_delta(mouse_delta_dir.x * -200, mouse_delta_dir.y * -200)
    }
...
class $bd288d7d1dcf423f7b63d9a1d4b266$export$default extends $e3cc03d83037209b37c43423c6e8302$export$default {
  ...
  update(camera_controller) {
    ...
    camera_controller.reference_zoom = _Math.clamp(camera_controller.reference_zoom, camera_controller.min_zoom, camera_controller.max_zoom)
  ...
  get_target_camera_pos(camera_controller) {
    ...
    const zoom = _Math.clamp(camera_controller.reference_zoom, camera_controller.min_zoom, camera_controller.max_zoom)
...
class $b962cf860b6cd5fd3e553d7e21122ee7$export$default {
  ...
  lerp_rotation(from_tilt, to_tilt, from_orientation, to_orientation, t) {
    ...
    this.set_rotation(_Math.lerp(from_tilt, to_tilt, t), _Math.lerp(from_orientation, to_orientation, t))
  ...
  focus_camera_on_points(points, zoom_scale = 1) {
    ...
    const camera_forward = new THREE.Vector3(0, 0, 1).applyQuaternion(this.reference_rotation) // let near_plane = points_sphere.center.clone().add(camera_forward.clone().multiplyScalar(points_sphere.radius));

    const far_pos = this.camera.position.clone().add(camera_forward.clone().multiplyScalar(100))
    const near_plane = ArrayUtilities.get_closest_point(points, far_pos).clone()
    const plane = new Plane().setFromNormalAndCoplanarPoint(camera_forward, near_plane)
    ...
    const up = new THREE.Vector3(0, 1, 0).applyQuaternion(this.reference_rotation)
    ...
    this.reference_position.copy(projected_center.applyMatrix4(mat).sub(camera_forward.clone().multiplyScalar(points_sphere.radius))) // let zoom_scale_nofake = 1 + (zoom_scale-1)*2;
...
class $c0b4a3fbc0bb081afa06457ec6f0b87$export$default extends $abc41a388d5324483742198167aaa2$export$default {
  ...
  on_block_hit(block) {
    const renderable_block = this.level_player.game_renderer.find_renderable_block(block)
...
class $a76a04770cece6e1e4f3ef622b508$export$default {
  ...
  build_block(block_data, block_thickness) {
    const block_body = this.create_block_body(block_data.x, block_data.y, block_thickness)
  ...
  create_wall_body(side = 'bottom', board_width = 0.1, board_height = 0.1) {
    ...
    switch (side) {
      case 'bottom':
        ...
        shape = _planckJs.Edge(_planckJs.Vec2(-board_width / 2, 0.0), _planckJs.Vec2(board_width / 2, 0))
        break

      case 'left':
        position = _planckJs.Vec2(0, board_height / 2)
        shape = _planckJs.Edge(_planckJs.Vec2(0, -board_height / 2), _planckJs.Vec2(0, board_height / 2))
        break
...
class $db2f1a94743d99979331b025c2dc5380$export$default {
  ...
  solve(raycaster, b, velocity, ignore_fixture, invocaciones) {
    ...
    const result = raycaster.raycast(current_pos, _planckJs.Vec2(new_x + skin_offset.x, new_y + skin_offset.y), this.game_context.world, ignore_fixture)
    ...
    if (result === undefined) {
      ...
      const remaining_reflected_velocity = this.reflect_vector(_planckJs.Vec2(reflected_dir_x, reflected_dir_y), result.normal)
...
class $f98c8857ddeb876a7390f5ffbe822d$export$default extends $a3461a2ab0e5222461c39d$export$default {
  ...
  fire_ball(game) {
    const ball = new $a76a04770cece6e1e4f3ef622b508$export$default(game.world).build_ball(game.level_descriptor.ball_radius)
...
class $cd3954c1f6daa465a4087f7301$var$Game {
  constructor(listener) {
    ...
    this.context = new $b834130c156ccd8f8675b284f28da$export$default(this.world, this.listener)
    this.collision_resolver = new $d541445c781c017043854442a$export$default(this)
    ...
    this.simulation = new $db2f1a94743d99979331b025c2dc5380$export$default(this.context, this.collision_resolver)
  ...
  import_state(level_descriptor) {
    ...
    this.current_state = new $c2d1f0a735523d1d8b0b771773$export$default().load(level_descriptor.game_state)
    this.elapsed_time = 0
  ...
  import_blocks(level_descriptor) {
    this.dispose()
    const level_builder = new $a76a04770cece6e1e4f3ef622b508$export$default(this.world)
    const thickness = level_descriptor.ball_radius * 2
    const blocks = level_builder.build_blocks(level_descriptor.blocks, thickness)
    const walls = level_builder.build_walls(level_descriptor.board_width, level_descriptor.board_height, level_descriptor.wall_color)
...
class $e9dbb159ee3fe8c38e95395ae101d60$export$default {
  constructor() {
    ...
    this.ball_array_drawer = new $a16788ec351f200743c866627a4bae7$export$default(0.1, '#bf5fff')
  }
...
const $ff879b7613681d9865f18b3a4e84e422$export$default = new $ff879b7613681d9865f18b3a4e84e422$var$Configuration()
...
class $a8b904b440ddb7e5569e90e81e7$export$default {
  constructor(game_wall) {
    ...
    const thickness = $ff879b7613681d9865f18b3a4e84e422$export$default.wall_thickness
    let width = 1
    let height = 1
...
const $fc75fffc7a940860aee61ff079b6c90$$interop$default = $parcel$interopDefault($fc75fffc7a940860aee61ff079b6c90$exports)
const $a199002a56156c7f9bee9ffabf3dabd6$$interop$default = $parcel$interopDefault($a199002a56156c7f9bee9ffabf3dabd6$exports)

class $db99185b917e4a2c189aae20bd3$export$default extends BaseShaderMaterial {
  constructor() {
    super($fc75fffc7a940860aee61ff079b6c90$$interop$default, $a199002a56156c7f9bee9ffabf3dabd6$$interop$default, {
      _MainTex: {
        value: undefined,
      },
      _Emission: {
...
class $e752c73555c3323de63adf84e9$export$default {
  constructor() {
    ...
    this.blocks = []
    this.walls = []
    this.ball_array_drawer = new $a16788ec351f200743c866627a4bae7$export$default(0.1)
  ...
  create_ball(game_ball) {
    this.balls.push(new $bf5de6c52db1dae76db33cf317e80e$export$default(game_ball))
  }

  create_block(game_block) {
    const text_element = this.text_batch.add_text('0')
    this.blocks.push(new $ae8db583dd4e3fb86ef40f5ffd0182$export$default(game_block, game_block.color, game_block.color_image, text_element))
  }
...
const $c27e9b9e0bdab27a1a114df73a7cfd81$$interop$default = $parcel$interopDefault($c27e9b9e0bdab27a1a114df73a7cfd81$exports)
const $b4830a97f7cf90fff621473769804dc$$interop$default = $parcel$interopDefault($b4830a97f7cf90fff621473769804dc$exports)

class $afca602b2ff40b402e0c70d517e52703$export$default extends BaseShaderMaterial {
  constructor() {
    super($c27e9b9e0bdab27a1a114df73a7cfd81$$interop$default, $b4830a97f7cf90fff621473769804dc$$interop$default, {
      _Col1: {
...
class $c6279a6a66ad33e41fa9ebdc6da9ee8f$export$default extends Mesh {
  constructor() {
    super(new PlaneBufferGeometry(), new $afca602b2ff40b402e0c70d517e52703$export$default())
  }
...
const $cd3954c1f6daa465a4087f7301$$interop$default = $parcel$interopDefault($cd3954c1f6daa465a4087f7301$exports)
...
class $cd10cabb5963c27a5d2696a76a0e6574$export$default extends $cfb2277e624a264ce0a58ec$export$default {
  constructor(player_view) {
    super()
    this.game = new $cd3954c1f6daa465a4087f7301$$interop$default(new $c0b4a3fbc0bb081afa06457ec6f0b87$export$default(this))
    ...
    this.point_array_drawer = new $e9dbb159ee3fe8c38e95395ae101d60$export$default()
  ...
  update() {
    ...
    const mouse = new Vector3(Input.NDC.x, Input.NDC.y, 0).unproject(CameraManager.current)
    const firing_dir = new Vector2(mouse.x - this.firing_point.x, mouse.y - this.firing_point.y).normalize()

    if (Input.left_mouse_button_down && this.game.can_fire() && this.camera_drag_cooldown < 0.01) {
      const start_point = new Vector3(this.firing_point.x, this.firing_point.y, 0)
      const clamped_firing_dir = this.game.get_clamped_firing_direction(firing_dir)
      const points = this.line_tracer.trace(start_point, new Vector3(clamped_firing_dir.x, clamped_firing_dir.y, 0), this.game_renderer.walls)
    ...
    this.game.update(Time.delta_time, _Math.lerp(1, 2, this.time_scale_strength))
  ...
  init_level(level_descriptor) {
    this.set_state(new $e6facc738b0114a29dec47fca3b201c5$export$default(level_descriptor))
  }
...
$c1fc7f677834f9bde79a0ad47fd859e9$exports = $c1fc7f677834f9bde79a0ad47fd859e9$var$TestGameListener
const $c1fc7f677834f9bde79a0ad47fd859e9$$interop$default = $parcel$interopDefault($c1fc7f677834f9bde79a0ad47fd859e9$exports)
...
class $ab03a0e9252d3d0656566105c97c220$export$default {
  ...
  init_level(level_descriptor) {
    const game_listener = new $c1fc7f677834f9bde79a0ad47fd859e9$$interop$default()
    ...
    setTimeout(() => {
      ...
      if (game.can_fire()) {
        ...
        while (game_listener.balls_cleared === false && game_listener.game_over === false) {
...
class $c99c0e8b197573f1fe23cab137$export$default extends $e6facc738b0114a29dec47fca3b201c5$export$default {
  ...
  start_loading(networked_level_player) {
    const self = this
    $a47b39a1f68b769584aa5500ce61083b$export$default.load_level_descriptor((level_descriptor) => {
  ...
  go_to_game_started(networked_level_player) {
    networked_level_player.set_state(new $af949736f0b948ab82b6f03ed47c69$export$default())
  }

  go_to_waiting_for_start(networked_level_player) {
    networked_level_player.set_state(new $eba838696ee19021e08bd9955f67a1ec$export$default())
  }
}
...
class $a52696df17fd399c238dbb25fb04b99b$export$default extends $cd10cabb5963c27a5d2696a76a0e6574$export$default {
  ...
  turn_ended(turn_number) {
    ...
    $a47b39a1f68b769584aa5500ce61083b$export$default.validate_score(turn_number, this.game.scores[turn_number].points, this.game.scores[turn_number].time)
  }
...
class $c5d515c847a1b1d5e42778a8813b19d$export$default extends $cfb2277e624a264ce0a58ec$export$default {
  constructor() {
    ...
    this.level_descriptor = undefined
    this.game_renderer = new $e752c73555c3323de63adf84e9$export$default()
    this.game = new $cd3954c1f6daa465a4087f7301$$interop$default(new $d6374b59454f8ed79a46986abd7ee14a$export$default(this))
  ...
  init_level(level_descriptor) {
    ...
    this.mock_block = new $a76a04770cece6e1e4f3ef622b508$export$default(this.game.world).build_block(
      {
        id: -1,
        x: 0,
        y: 0,
  ...
  update() {
    ...
    this.game_renderer.update()
    const mouse = new Vector3(Input.NDC.x, Input.NDC.y, 0).unproject(CameraManager.current)
    const position = new Vector2(Math.floor(mouse.x) + 0.5, Math.floor(mouse.y) + 0.5)
    const is_point_widthin_bounds = this.point_is_within_bounds(position.x, position.y)
    const is_point_over_a_block = this.point_is_over_a_block(position.x, position.y)
  ...
  point_is_within_bounds(x, y) {
    if (MathUtilities.between(x, 0, this.level_descriptor.board_width) && MathUtilities.between(y, 0, this.level_descriptor.board_height)) {
      return true
    }
  ...
  create_game_block(x, y, color_image = 'blue', total_hp = 1) {
    ...
    const block = new $a76a04770cece6e1e4f3ef622b508$export$default(this.game.world).build_block(
      {
...
class $f3a324c807c98acbf0952b9675$export$default extends $cbea740ada5053a558f611980f96c698$export$default {
  ...
  set_score(score_index, points, time) {
    ...
    const score_container = document.querySelector('.playing__shoot--'.concat(score_index))
  ...
  set_shoot_score(score_container, index, points, time) {
    ...
    score_container.querySelector('.playing__shoot-number').textContent = 'Shoot '.concat(index + 1, ': ')
    score_container.querySelector('.playing__shoot-score').textContent = points
    score_container.querySelector('.playing__shoot-timer-time').textContent = Math.trunc(time * 100) / 100
  }
...
class $c382e361c5b27c638bb1cfc719cf1871$export$default extends BaseApplication {
  constructor() {
    super()
    this.camera_controller = new $b962cf860b6cd5fd3e553d7e21122ee7$export$default()
  ...
  set_level(json) {
    ...
    this.set_state(new $cd10cabb5963c27a5d2696a76a0e6574$export$default(this.playing_view))
    json = json || window.current_level_descriptor
    const level_descriptor = json || this.get_dummy_level_descriptor(this.settings)
  ...
  set_online_level() {
    this.playing_view.restart_scores()
    this.set_state(new $a52696df17fd399c238dbb25fb04b99b$export$default(this.playing_view))
  ...
  update() {
    ...
    const wall_thickness = $ff879b7613681d9865f18b3a4e84e422$export$default.wall_thickness
    ...
    this.camera_controller.reference_position.y =
      (CameraManager.current.top - CameraManager.current.bottom) / 2 - $ff879b7613681d9865f18b3a4e84e422$export$default.wall_thickness
    ...
    const camera_height = CameraManager.current.top - CameraManager.current.bottom
    this.target_y_offset = Math.min(29 + $ff879b7613681d9865f18b3a4e84e422$export$default.wall_thickness * 2 - camera_height, this.target_y_offset)
...
class $d3a1e1b785bcf3197e0ebe68$var$Api {
  constructor() {
    this.application = new $c382e361c5b27c638bb1cfc719cf1871$export$default(Graphics)
