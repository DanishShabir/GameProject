...
export default {
  ...
  delHearAboutUs(platformId) {
    return AxiosService.delete(
      `${basePath}/hear-about-us-platforms/${platformId}`
    )
  },
  ...
  editHearAboutUs(payload) {
    return AxiosService.put(
      `${basePath}/hear-about-us-platforms/${payload.id}`,
      payload
    )
  },
  getHearAboutUsWithCount() {
    return AxiosService.get(`${basePath}/hear-about-us-platform-count`)
  },
}
