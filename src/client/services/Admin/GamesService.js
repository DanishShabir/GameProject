...
export default {
  ...
  getGameDetails(gameId) {
    return AxiosService.get(`${basePath}/games/${gameId}?include=players`)
  },
  /**
  ...
  /**
   * Method to update game winners
   */
  updateGameWinners(id, payload) {
    return AxiosService.post(`${basePath}/games/${id}/update-winners`, payload)
  },
}
